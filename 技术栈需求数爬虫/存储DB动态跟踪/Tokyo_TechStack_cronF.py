...
def savedt():
    ...
    excelFile3 = '{0}/{1}.xlsx'.format(ln, "Tokyo_TSN_f")  # 处理了文件属于当前目录下！
...
def sendmail():
    ...
    try:
        ...
        xlsxpart3 = MIMEApplication(open('{0}/Tokyo_TSN_f.xlsx'.format(ln), 'rb').read())
        xlsxpart3.add_header('Content-Disposition', 'attachment', filename='Tokyo_TSN_f.xlsx')
